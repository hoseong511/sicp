...
(define wave
  (segments->painter
   (list (segment (vect .25 0) (vect .35 .5)) 
         ...
         (segment (vect .35 .85) (vect .65 .85))
         (segment (vect .45 .9) (vect .55 .9))
         (segment (vect .5 .95) (vect .5 .85))
...
(define (below2rotate painter1 painter2)
  (rotate90r (beside (rotate90 painter1) (rotate90 painter2))))

(paint wave)
(paint (shrink-to-upper-right wave))
(paint (rotate90 wave))
(paint (rotate90 (rotate90 wave)))
(paint (rotate90 wave))
(paint (rotate90 (rotate90 wave)))
...
(paint (rotate90r einstein))
(paint (rotate180 einstein))

(paint (below2rotate einstein wave))